        ...
        <template v-slot:activator="{ props }">
            <div class="custom-hover-primary text-left px-0 cursor-pointer" variant="text" v-bind="props">
                <div class="d-flex align-center">
                    <v-avatar size="50">
                        <img src="@/assets/images/profile/user6.jpg" width="50" alt="Ali Nahhas" />
                    </v-avatar>
                    <div class="ml-md-4 d-md-block d-none">
                        <h6 class="text-h6 d-flex align-center text-black font-weight-semibold">Ali Nahhas</h6>
        ...
        <v-sheet rounded="lg" width="385" elevation="10" class="mt-5">
            <div class="px-8 pt-6">
                ...
                <div class="d-flex align-center mt-5 pb-6">
                    ...
                    <div class="ml-5">
                        <h6 class="text-h5 mb-n1">Ali Nahhas</h6>
